namespace OpenNGS.Crypto
{
    public class TEA
    {
        ...
        */
        ...
        public static bool SymmetryDecrypt2(byte[] pInBuf, int nInBufLen, byte[] pKey, byte[] pOutBuf, ref int pOutBufLen)
        {
        ...
        */
        ...
        public static int SymmetryEncrypt2Len(int nInBufLen)
        {
        ...
        */
        /*TEA加密算法,CBC模式*/
        /*密文格式:PadLen(1char)+Padding(var,0-7char)+Salt(2char)+Body(var char)+Zero(7char)*/
        public static void SymmetryEncrypt2(byte[] pInBuf, int nInBufLen, byte[] pKey, byte[] pOutBuf, ref int pOutBufLen)
        {
