...
{
    internal struct ContractOperation
    {
        ...
        MethodType methodType, ContextKind contextKind, ResultKind arg, ResultKind resultKind, VoidKind @void)
        {
            ...
            this.Context = contextKind;
            this.Arg = arg;
            this.Result = resultKind;
            this.Void = @void;
        }
        ...
        public ContextKind Context { get; private set; }
        public ResultKind Arg { get; private set; }
        public ResultKind Result { get; private set; }
        public VoidKind Void { get; private set; }
