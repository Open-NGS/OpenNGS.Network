...
public class OpenNGSTabButton : VisualElement
{
    internal new class UxmlFactory : UxmlFactory<OpenNGSTabButton, UxmlTraits> { }
    ...
    internal new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        {
            base.Init(ve, bag, cc);
            OpenNGSTabButton item = ve as OpenNGSTabButton;
    ...
    static readonly string styleName = "OpenNGSTabButton";
    static readonly string UxmlName = "OpenNGSTabButton";
    ...
    public event Action<OpenNGSTabButton> OnSelect;
    public event Action<OpenNGSTabButton> OnClose;
    
    public OpenNGSTabButton()
    {
        Init();
    }

    public OpenNGSTabButton(string text, VisualElement target)
    {
        Init();
        m_Label.text = text;
        Target = target;
    ...
    private void Init()
    {
        ...
        styleSheets.Add(Resources.Load<StyleSheet>($"{styleName}"));

        VisualTreeAsset visualTree = Resources.Load<VisualTreeAsset>($"{UxmlName}");
