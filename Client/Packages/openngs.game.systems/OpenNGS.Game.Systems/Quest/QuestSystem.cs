...
//            {
//                bool bFound = false;
//                foreach(QuestGroupData _groupData in questContainer.QuestGroupList)
//                {
...
//                        _questData.Status = Quest_Status.Status_None;
//                        _groupData.QuestDataList.Add(_questData);
//                    }
...
//        {
//            foreach (var questGroup in questContainer.QuestGroupList)
//            {
...
//                    {
//                        foreach(QuestData _questData in _groupData.QuestDataList)
//                        {
//                            ExecuteQuest(_questData);
//                        }
//                        break;
...
//            if(quest != null)
//            {
//                quest.Status = Quest_Status.Status_Progress;
...
//        {
//            QuestData quest = questContainer.GetQuestById(questGroupID, questID);
//            if (quest != null && quest.Status == Quest_Status.Status_Progress)
//            {
...
//                    if (nextQuest != null && nextQuest.Status != Quest_Status.Status_Progress)
//                    {
...
//            if(_quest != null)
//            {
//                questContainer.UpdateQuest(_quest, Quest_Status.Status_Completed);
...
//                    if(_questInf != null)
//                    {
//                        if (!_questInf.IsBan && questDetail.Status != Quest_Status.Status_Completed)
//                        {
//                            return false;
//                        }
//                    }
