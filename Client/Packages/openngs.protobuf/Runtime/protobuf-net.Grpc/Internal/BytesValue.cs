...
namespace ProtoBuf.Grpc.Internal
{
    ...
    public sealed class BytesValue
    {
        ...
        public BytesValue(byte[] oversized, int length, bool pooled)
        {
            this._flags = pooled ? Flags.Pooled : Flags.None;
        ...
        private BytesValue() : this(new byte[] { }, 0, false) { } // for deserialization 
