...
namespace ProtoBuf.Grpc.Configuration
{
    ...
    public abstract class ClientFactory
    {
        ...
        private sealed class ConfiguredClientFactory : ClientFactory
        {
            ...
            protected override BinderConfiguration BinderConfiguration { get { return binderConfiguration; } }
            ...
            {
                this.binderConfiguration = binderConfiguration ?? BinderConfiguration.Default;
            }
