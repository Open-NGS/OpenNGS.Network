...
namespace ProtoBuf.Serializers
{
    public class MapDecorator<TDictionary, TKey, TValue> : ProtoDecoratorBase where TDictionary : class, IDictionary<TKey, TValue>
    {
        ...
        protected MapDecorator(TypeModel model, Type concreteType, IProtoSerializer keyTail, IProtoSerializer valueTail,
     ...
     class AotClassSolover : ProtoBuf.Serializers.MapDecorator<
        System.Collections.Generic.Dictionary<System.Int64, System.Int64>, System.Int64, System.Int64>
    {
        public AotClassSolover(TypeModel model, Type concreteType, IProtoSerializer keyTail, IProtoSerializer valueTail, int fieldNumber, WireType wireType, WireType keyWireType, WireType valueWireType, bool overwriteList) : base(model, concreteType, keyTail, valueTail, fieldNumber, wireType, keyWireType, valueWireType, overwriteList)
        {
        }
    }
