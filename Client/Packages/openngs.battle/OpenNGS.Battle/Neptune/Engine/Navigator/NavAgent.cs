...
namespace Neptune
{
    public abstract class NavAgent
    {
        ...
        public NavAgent(Entity element)
        {
            this.Owner = element;
            this.AreaMask = -1;
        }
        public NavAgent(Entity element, int AreaMask)
        {
            this.Owner = element;
        ...
        {
            NextPosition = NeptuneConst.UVector2Zero;
        }
        public abstract void SetDestination(UVector3 destination, bool forceRPF = false, NavMeshPath path = null);
