...
namespace Neptune
{
    ...
    public interface IEngineDataProvider
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        BattleLevelData GetLevelData(int id);
        ...
        Dictionary<int, TalentGroupData> GetTalentGroups(int id);

        RoleData GetRoleData(int id);

        Dictionary<int, RoleGrowthData> GetRoleGrowthDatas(int id);

        Dictionary<int, TalentData> GetTalentDatas(int id);

        Dictionary<int, TalentData> GetTalentLevelDatas(int id);
