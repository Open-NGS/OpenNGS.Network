...
namespace Neptune
{
     ...
     *    修改后请运行编辑器菜单 [uCool] -> [Development] -> [Check RoleAttributes] 执行检查。
     *    
     *    W A R N I N G     W A R N I N G     W A R N I N G     W A R N I N G     W A R N I N G
     */
    ...
    public struct RoleAttributes
    {
        ...
        /// 攻击时额外造成魔法伤害
        /// </summary>
        public int ExtraAbilityPower;
        /// <summary>
        /// 攻击时额外造成真实伤害
        /// </summary>
        public int ExtraHoly;
        ...
        public static int GetRatioValueField(int name)
        {
            return (int)RoleAttribute.RATIOBASE + name;
        }
        public static int GetRatioValueField(RoleAttribute name)
        {
            return (int)RoleAttribute.RATIOBASE + (int)name;
        }
        public static int GetPlusValueField(int name)
        {
            return (int)RoleAttribute.PLUSBASE + name;
        }
        public static int GetPlusValueField(RoleAttribute name)
        {
            return (int)RoleAttribute.PLUSBASE + (int)name;
        }

        public static int GetBaseValueField(int ratio_name)
        {
            return ratio_name - (int)RoleAttribute.RATIOBASE;
        }
    }
}