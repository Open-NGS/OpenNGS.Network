...
{
    [Serializable]
    public class AbilityData : GameDataArray<float>
    {
        ...
        public List<int> SkipAbilitys { get; set; }
        public int LevelFactor { get; set; }
        public bool Irresistible { get; set; }
        public float Probability { get; set; }
        public bool DontRemoveOnDeath { get; set; }
        public string PopupText { get; set; }
        public List<RoleAttribute> GrowthFields { get; set; }
        public List<int> CDReductions { get; set; }
        public List<int> DamageFactors { get; set; }
        public int MaxOverlayLayer { get; set; }
        public string TargetHeroTag { get; set; }
        public RoleType EffectRoleType { get; set; }
        public float Time { get { return base.Values[(int)RoleAttribute.Time]; } set { base.Values[(int)RoleAttribute.Time] = value; } }
        /// <summary>
        /// 根据Base属性计算Ratio值
        /// </summary>
        ...
        public float RageRegen { get { return base.Values[(int)RoleAttribute.RageRegen]; } set { base.Values[(int)RoleAttribute.RageRegen] = value; } }
        public float PointRegen { get { return base.Values[(int)RoleAttribute.PointRegen]; } set { base.Values[(int)RoleAttribute.PointRegen] = value; } }
       ...
       public float CDReduction { get { return base.Values[(int)RoleAttribute.CDReduction]; } set { base.Values[(int)RoleAttribute.CDReduction] = value; } }
        ...
        public float RageRegen_a { get { return base.Values[RoleAttributes.GetRatioValueField(RoleAttribute.RageRegen)]; } set { base.Values[RoleAttributes.GetRatioValueField(RoleAttribute.RageRegen)] = value; } }
        public float PointRegen_a { get { return base.Values[RoleAttributes.GetRatioValueField(RoleAttribute.PointRegen)]; } set { base.Values[RoleAttributes.GetRatioValueField(RoleAttribute.PointRegen)] = value; } }
        ...
        //public RoleAttribute AttackDamage_x { get { return (RoleAttribute)this.PlusField[(int)RoleAttribute.AttackDamage]; } set { this.PlusField[(int)RoleAttribute.AttackDamage] = (int)value; } }
        //public RoleAttribute Armor_x { get { return (RoleAttribute)this.PlusField[(int)RoleAttribute.Armor]; } set { this.PlusField[(int)RoleAttribute.Armor] = (int)value; } }
        //public RoleAttribute HPDecrease_x { get { return (RoleAttribute)this.PlusField[(int)RoleAttribute.HPDecrease]; } set { this.PlusField[(int)RoleAttribute.HPDecrease] = (int)value; } }
        ...
        public List<int> ControlEffects { get; set; }
        ...
        public float ShieldValue { get { return base.Values[(int)RoleAttribute.ShieldValue]; } set { base.Values[(int)RoleAttribute.ShieldValue] = value; } }
        ...
        //public List<RoleAttribute> AbilityLevelupID { get; set; }
        //public List<int> AbilityLevelupvalue { get; set; }
        //public List<RoleAttribute> AbilityLevelupRatioID { get; set; }
        //public List<int> AbilityLevelupRatiovalue { get; set; } 
        ...
        public List<int> ActiveTalentIDs { get; set; }
        ...
        public bool IsControlAbility
        {
            get
            {   
                if(this.ControlEffects == null || this.ControlEffects.Count <= 0)
                {
                    return false;
                }
                ...
                {
                    if (EngineConst.ConflictingAbilities.ContainsKey((int)effect))
                    {
                        return true;
                    }
                }
