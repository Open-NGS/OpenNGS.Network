...
namespace Neptune
{
    ...
    public interface IActorController : IController
    {
        ...
        int AddEffect(string name, EffectType type, Vector3 offset, IActorController source = null, string bindingNode = "");
        /// <summary>
    ...
    public class NullActorController : IActorController
    {
        ...
        public int AddEffect(string name, EffectType type, Vector3 offset, IActorController source = null, string bindingNode = "")
        {
            return -1;
        }
