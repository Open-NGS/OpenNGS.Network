...
namespace OpenNGS.UI
{
    ...
    public class RecyclableScrollRectEditor : Editor
    {
        ...
        SerializedProperty m_OnConfigCell;
        SerializedProperty m_OnCreateCell;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_OnConfigCell = serializedObject.FindProperty("m_OnScrollEvent");
            m_OnCreateCell = serializedObject.FindProperty("m_OnCreateCell"); 
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_OnConfigCell);
            EditorGUILayout.PropertyField(m_OnCreateCell);
