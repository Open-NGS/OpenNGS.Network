...
namespace Neptune
{
    ...
    /// </summary>
    public abstract class BattleEntity : PoolObj
    {
        /// <summary>
        /// 元件所属阵营
        /// </summary>
        ...
        /// 获取元件名称
        /// </summary>
        public virtual string Name { get { return "BattleEntity"; } }
        ...
        public RelativeSide GetRelation(BattleEntity other)
        {
        ...
        public string SideSign
        {
            get
            {
                ...
                {
                    case RoleSide.SideA:
                        return EngineConst.SymbolPlus;
                    case RoleSide.SideB:
                        return EngineConst.SymbolMinus;
                    default:
                        return string.Empty;
                }
            }
        ...
        public BattleEntity()
        {
            ...
            this.Speed = EngineConst.Vector2Zero;
            this.IsPause = false;
        ...
        protected void Create()
        {
            ...
            this.Running = true;
            this.DamageFactor = 0;
            this.ShoveSpeed = EngineConst.Vector2Zero;
            this.Height = 0;
            this.AOIIndex = -1;
            this.joint = null;
        }
        ...
        /// <returns></returns>
        public bool HitTest(BattleEntity element, int radius = 0)
        {
        ...
        /// <returns></returns>
        public int Distance(BattleEntity target, bool radius)
        {
        ...
        {
            //Debug.Log("BattleEntity Suspend");
            this.IsPause = true;
        ...
        public static bool RemoveStopedElement(BattleEntity e)
        {
            if (e.Running == false)
            {
                e.Delete();
