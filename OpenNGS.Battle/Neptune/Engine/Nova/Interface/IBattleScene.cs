...
namespace Neptune
{
    ...
    public interface IBattleScene
    {
        ...
        void AddJoint(IBattleAgent joint);
        ...
        void ShowDropGolds(int num, BattleActor role);
        /// <summary>
        ...
        void ShowDropLoots(int round, BattleActor monster, float lost_hp, float last_lost_hp);
        ...
        void PopupText(PopupType type, string str, int number, IBattleAgent actor, IBattleAgent from, bool crit, RoleSide side, RoleAttribute exType = RoleAttribute.None, AbilityData abilityData = null);
        ...
        void OnRoleDeath(BattleActor role, BattleActor attacker, BattleSkill fromTalent = null);

        void RoleReborn(BattleActor hero);
        ...
        /// <returns></returns>
        bool EffecVisible(BattleEffect effect);

        void AddEffectOnMap(BattleEffect effect);
    }
}