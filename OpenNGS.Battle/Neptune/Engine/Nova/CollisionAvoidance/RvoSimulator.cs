...
public class RvoSimulator : IOrcaSimulator
{
    ...
    private int normalNeighborDist = EngineConst.RVO_NeighborDist;
    private int normalNeighborObstDist = EngineConst.RVO_NeighborObstDist;
    private float normalNeighborTimeHorizon = EngineConst.RVO_NeighborTimeHorizon;
    private float normalNeighborObstTimeHorizon = EngineConst.RVO_NeighborObstTimeHorizon;
    private int normalMaxSpeedThreshold = EngineConst.RVO_MaxSpeedThreshold;
    private float normalMinSpeedFactor = EngineConst.RVO_MinSpeedFactor;
    private bool normalForceSpeed = EngineConst.RVO_ForceSpeed;
    private bool normalRepelCollisionWithBuilding = EngineConst.RVO_RepelCollision_Building;
    ...
    public OrcaAgent CreateAgent(BattleActor ele, UVector2 pos, int radius, int maxSpeed, RvoContainType type)
    {
    ...
    public void RemoveAgent(BattleActor ele)
    {
        if (ele != null)
        {
