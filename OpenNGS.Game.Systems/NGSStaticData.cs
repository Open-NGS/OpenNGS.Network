...
namespace OpenNGS.Systems
{
    public static class NGSStaticData
    {
        ...
        public static Table<OpenNGS.Shop.Data.BuyItemInfo, uint, uint> buyItem = new Table<OpenNGS.Shop.Data.BuyItemInfo, uint, uint>((item) => { return item.ShopItemId; }, (item) => { return item.ShopItemId; }, false);
